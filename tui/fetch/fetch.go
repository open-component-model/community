...
// ResourceDownloader abstracts downloading a single resource to disk.
type ResourceDownloader interface {
	// DownloadResource downloads a resource from the given component version to outputDir.
	// The reference is the original repository reference string (e.g. "ghcr.io/org/repo").
	// It returns the path of the downloaded file/directory.
	DownloadResource(ctx context.Context, reference, component, version string, resource *descriptor.Resource, outputDir string) (string, error)
}
